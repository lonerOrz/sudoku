...
| **Phase 5** | Variant Support | 12 | 🔄 50% | Optional |
...
| 5.2.5 | Asterisk | Medium | P2 | 2h | `grid/variant.rs` | [x] | `asteriskVisibleCellIndex` |
| 5.2.6 | Girandola | Medium | P2 | 2h | `grid/variant.rs` | [x] | `girandolaVisibleCellIndex` |
